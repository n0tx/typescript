var nama_user = "Riki Candra";
console.log(nama_user); // Riki Candra
console.log({ nama_user: nama_user }); // { nama_user: 'Riki Candra' }
/*
...
muncul karena secara default TypeScript memperlakukan semua file .ts yang tidak “dibungkus” sebagai script tunggal dalam satu global scope.
*/ 
